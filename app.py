...
model_mapping = {
       ...
       "distilgpt2": "Mrbean01/uzair_amiin", "gptneo": "Mrbean01/your_model_name"  
   }
...
if st.button("Get Response"):
    try:
        ...
        response = generate_response(user_prompt, tokenizer, model, temperature=0.7, top_k=60, top_p=0.8)
